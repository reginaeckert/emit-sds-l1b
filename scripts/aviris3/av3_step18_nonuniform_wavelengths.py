...
wavelengths = np.array([2064.350098, 1550.599976, 1064.00, 632.8300171, 532.19, 406.7])
sampling = 8.6
uncert = sampling *  np.array([1, 0.1, 0.007, 0.026, 0.079, 0.077]) 
# Eckert: Educated guess of 0.1 uncertainty for second wavelength, no measurements currently
